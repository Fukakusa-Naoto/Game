...
//! @file		Take8.h
//!
//! @summary	テイク8のアニメーションクラスのヘッダファイル
//!
//! @date		2018.11.12
//!
//! @author		深草直斗
	...
	namespace Play
	{
		namespace Object
		{
			namespace UI
			{
				...
				// クラスの定義 ==================================================
				class Take8 : public AnimeCrip
				{
					// <メンバ変数>
				private:
					DirectX::SimpleMath::Vector2 m_startPositionPartsB;
					DirectX::SimpleMath::Vector2 m_startPositionNowScore;
					DirectX::SimpleMath::Vector2 m_startPositionHighScore;
					DirectX::SimpleMath::Vector2 m_startPositionTopParts;
					DirectX::SimpleMath::Vector2 m_startPositionBottomParts;
					DirectX::SimpleMath::Vector2 m_startPositionItemBackground;
				...
				public:
					...
					//------------------------------------------------------
					Take8(Animator* animator, AnimeTakes* animeTakes, UIParts* uiParts);
