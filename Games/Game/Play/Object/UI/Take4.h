...
//! @file		Take4.h
//!
//! @summary	テイク4のアニメーションクラスのヘッダファイル
//!
//! @date		2018.11.12
//!
//! @author		深草直斗
	...
	namespace Play
	{
		namespace Object
		{
			namespace UI
			{
				...
				// クラスの定義 ==================================================
				class Take4 : public AnimeCrip
				{
					// <メンバ変数>
				private:
					DirectX::SimpleMath::Vector2 m_startPositionPartsB;
					DirectX::SimpleMath::Vector2 m_startPositionPartsC;
				...
				public:
					...
					//------------------------------------------------------
					Take4(Animator* animator, AnimeTakes* animeTakes, UIParts* uiParts);
