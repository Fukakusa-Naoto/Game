...
Common::DeviceResources::DeviceResources(DXGI_FORMAT backBufferFormat, DXGI_FORMAT depthBufferFormat, UINT backBufferCount, D3D_FEATURE_LEVEL minFeatureLevel, unsigned int flags) :
    m_screenViewport{},
...
void Common::DeviceResources::CreateDeviceResources()
{
...
void Common::DeviceResources::CreateWindowSizeDependentResources()
{
    if (!m_window)
    {
...
void Common::DeviceResources::SetWindow(HWND window, int width, int height)
{
    m_window = window;
...
bool Common::DeviceResources::WindowSizeChanged(int width, int height)
{
    RECT newRc;
...
void Common::DeviceResources::HandleDeviceLost()
{
    if (m_deviceNotify)
    {
...
void Common::DeviceResources::Present()
{
    HRESULT hr;
    if (m_options & c_AllowTearing)
    {
...
void Common::DeviceResources::CreateFactory()
{
...
void Common::DeviceResources::GetHardwareAdapter(IDXGIAdapter1** ppAdapter)
{
    *ppAdapter = nullptr;
...
void Common::DeviceResources::UpdateColorSpace()
{
